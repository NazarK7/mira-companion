...
export class AppButtonComponent {
  ...
  // Creiamo uno State Derivato tramite computed() per evitare la concatenazione inline nell'HTML
  readonly buttonClasses = computed(() => {
    return `${this.variantClasses[this.variant()]} ${this.sizeClasses[this.size()]}`;
  });
}